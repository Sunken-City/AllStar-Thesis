...
void TheGame::InitializeSpriteLayers()
{
    ...
    SpriteGameRenderer::instance->CreateOrGetLayer(BACKGROUND_PARTICLES_BLOOM_LAYER)->m_numBloomPasses = 2;
...
void TheGame::RegisterSprites()
{
    ...
    ResourceDatabase::instance->RegisterSprite("Turret", "Data\\Images\\Enemies\\turret.png");
