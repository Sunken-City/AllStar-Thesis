...
void TheGame::RegisterParticleEffects()
{
    ...
    yellowStars->m_properties.Set<Vector2>(PROPERTY_DELTA_SCALE_PER_SECOND, Vector2(1.3f));
    ...
    yellowStars->m_properties.Set<Range<unsigned int>>(PROPERTY_INITIAL_NUM_PARTICLES, 1);
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_SCALE, Range<Vector2>(Vector2(0.2f), Vector2(0.4f)));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_VELOCITY, Vector2::ZERO);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_PARTICLE_LIFETIME, DEATH_ANIMATION_LENGTH);
    yellowStars->m_properties.Set<float>(PROPERTY_PARTICLES_PER_SECOND, 0.0f);
    yellowStars->m_properties.Set<Vector2>(PROPERTY_DELTA_SCALE_PER_SECOND, Vector2(1.3f));
    ...
    yellowStars->m_properties.Set<Range<unsigned int>>(PROPERTY_INITIAL_NUM_PARTICLES, Range<unsigned int>(5, 10));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_SCALE, Range<Vector2>(Vector2(0.2f), Vector2(0.4f)));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_VELOCITY, Vector2::ZERO);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_PARTICLE_LIFETIME, DEATH_ANIMATION_LENGTH);
    yellowStars->m_properties.Set<float>(PROPERTY_PARTICLES_PER_SECOND, 0.0f);
    yellowStars->m_properties.Set<Vector2>(PROPERTY_DELTA_SCALE_PER_SECOND, Vector2(0.0f, 2.0f));
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_INITIAL_ROTATION_DEGREES, Range<float>(0.0f, 360.0f));
    ...
    yellowStars->m_properties.Set<Range<unsigned int>>(PROPERTY_INITIAL_NUM_PARTICLES, Range<unsigned int>(5, 15));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_SCALE, Range<Vector2>(Vector2(0.2f), Vector2(0.4f)));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_VELOCITY, Vector2::UNIT_Y);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_PARTICLE_LIFETIME, 0.5f);
    yellowStars->m_properties.Set<float>(PROPERTY_PARTICLES_PER_SECOND, 0.0f);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_MAX_EMITTER_LIFETIME, POWER_UP_PICKUP_ANIMATION_LENGTH);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_SPAWN_RADIUS, Range<float>(0.4f, 0.6f));
    yellowStars->m_properties.Set<Vector2>(PROPERTY_DELTA_SCALE_PER_SECOND, Vector2(1.3f));
    ...
    yellowStars->m_properties.Set<Range<unsigned int>>(PROPERTY_INITIAL_NUM_PARTICLES, Range<unsigned int>(2, 4));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_SCALE, Range<Vector2>(Vector2(0.2f), Vector2(0.4f)));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_VELOCITY, Vector2::UNIT_Y);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_PARTICLE_LIFETIME, 0.2f);
    yellowStars->m_properties.Set<float>(PROPERTY_PARTICLES_PER_SECOND, 0.0f);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_MAX_EMITTER_LIFETIME, MUZZLE_FLASH_ANIMATION_LENGTH);
    yellowStars->m_properties.Set<Vector2>(PROPERTY_DELTA_SCALE_PER_SECOND, Vector2(-0.3f));
    ...
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_PARTICLE_LIFETIME, 0.5f);
    yellowStars->m_properties.Set<float>(PROPERTY_PARTICLES_PER_SECOND, 0.0f);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_MAX_EMITTER_LIFETIME, CRATE_DESTRUCTION_ANIMATION_LENGTH);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_SPAWN_RADIUS, Range<float>(0.4f, 0.6f));
    yellowStars->m_properties.Set<Vector2>(PROPERTY_DELTA_SCALE_PER_SECOND, Vector2(1.3f));
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_INITIAL_ROTATION_DEGREES, Range<float>(0.0f, 360.0f));
    ...
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_SCALE, Range<Vector2>(Vector2(0.2f), Vector2(0.4f)));
    yellowStars->m_properties.Set<Range<Vector2>>(PROPERTY_INITIAL_VELOCITY, -Vector2::UNIT_Y);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_PARTICLE_LIFETIME, 1.5f);
    yellowStars->m_properties.Set<float>(PROPERTY_PARTICLES_PER_SECOND, 1.0f);
    yellowStars->m_properties.Set<Range<float>>(PROPERTY_MAX_EMITTER_LIFETIME, 0.0f);
    yellowStars->m_properties.Set<Vector2>(PROPERTY_DELTA_SCALE_PER_SECOND, Vector2(2.0f));
